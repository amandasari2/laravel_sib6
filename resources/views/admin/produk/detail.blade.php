            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="project-info-box">
                        ...
                        <p><b>Stok :</b> {{ $p->stok }} </p>
                        <p class="mb-0"><b>Minimal Stok :</b> {{ $p->min_stok }} </p>
                    </div><!-- / project-info-box -->
                ...
                <div class="col-md-7">
                    @empty($p->foto)
                        <img src="{{ url('admin/images/nophoto.jpg') }}" alt="project-image" class="rounded">
                    @else
                        <img src="{{ url('admin/images') }}/{{ $p->foto }}" alt="project-image" class="rounded">
                    @endempty
                    <div class="project-info-box">
