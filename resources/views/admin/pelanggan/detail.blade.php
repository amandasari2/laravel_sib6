            ...
            <div class="col-md-7 col-lg-4 mb-5 mb-lg-0 wow fadeIn">
                <div class="card border-0 shadow">
                    @empty($pelanggan->foto)
                        <img src="{{ url('admin/images/nophoto.jpg') }}" alt="...">
                    @else
                        <img src="{{ url('admin/images') }}/{{ $pelanggan->foto }}" alt="...">
                    @endempty
                    ...
                    <div class="card-body p-1-9 p-xl-5">
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            <li class="mb-3"><a href="#!">
                                    <i class="fa-solid fa-children display-25 me-3 text-secondary">

                                    </i>{{ $pelanggan->jk }}</a></li>
                            <li><a href="#!">
                                    <i class="fas fa-map-marker-alt display-25 me-3 text-secondary">

                                    </i>{{ $pelanggan->tmp_lahir }}</a></li>
                        </ul>
